...
<template>
  <div>
    ...
    <el-checkbox v-model="checked2" label="备选项3" border disabled></el-checkbox>
  </div>
  <div style="margin-top: 20px">
    ...
    <el-checkbox v-model="checked4" label="备选项3" border size="medium" disabled></el-checkbox>
  </div>
  <div style="margin-top: 20px">
    <el-checkbox-group v-model="checkboxGroup1" size="small">
      <el-checkbox label="备选项1" border></el-checkbox>
      <el-checkbox label="备选项2" border></el-checkbox>
      <el-checkbox label="备选项3" border disabled></el-checkbox>
    </el-checkbox-group>
  </div>
  <div style="margin-top: 20px">
  ...
  export default {
    data () {
      return {
        ...
        checked3: false,
        checked4: true,
        checkboxGroup1: ['备选项2', '备选项3'],
        checkboxGroup2: ['备选项2', '备选项3']
      };
    }
  }
</script>
