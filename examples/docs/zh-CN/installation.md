...
```shell
npm i rowinself-ui -S
```

### CDN

目前可以通过 [unpkg.com/rowinself-ui](https://unpkg.com/rowinself-ui/) 获取到最新版本的资源，在页面上引入 js 和 css 文件即可开始使用。

```html
<!-- 引入样式 -->
<link rel="stylesheet" href="https://unpkg.com/rowinself-ui/lib/theme-chalk/index.css">
<!-- 引入组件库 -->
<script src="https://unpkg.com/rowinself-ui/lib/index.js"></script>
```
