...
```javascript
import Vue from 'vue';
import ElementUI from 'rowinself-ui';
import 'rowinself-ui/lib/theme-chalk/index.css';
...
```javascript
import Vue from 'vue';
import { Button, Select } from 'rowinself-ui';
import App from './App.vue';
...
```js
import Vue from 'vue';
import { Button } from 'rowinself-ui';
