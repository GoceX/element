...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'rowinself-ui/src/utils/date-util';
  import { hasClass } from 'rowinself-ui/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'rowinself-ui/src/utils/util';
