<template>
  <div 
    ...
    <div
      ...
      ref="rightFixedPatch"
      :style="{ width: layout.scrollY ? layout.gutterWidth + 'px' : '0',
...
<script type="text/babel">
  import ElCheckbox from 'rowinself-ui/packages/checkbox';
  import { debounce, throttle } from 'throttle-debounce';
  import { addResizeListener, removeResizeListener } from 'rowinself-ui/src/utils/resize-event';
  import Mousewheel from 'rowinself-ui/src/directives/mousewheel';
